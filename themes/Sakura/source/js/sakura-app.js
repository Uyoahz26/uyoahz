  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/other/gravatar.jpg')
      } else {
        ele.src = 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/other/default_gavatar.jpg'
      break
    case 3:

      ele.src = 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/other/image-404.png'
      break
    default:
      ele.src = 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/other/image-404.png'
  }
    ...
    for (var i = 0; i < this.files.length; i++) {
      ...
      $.ajax({
        ...
        beforeSend: function (xhr) {
          ...
          $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/loader/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />')
          lazyload()
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/themebg/sakura.png' || bgurl == 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/themebg/plaid.jpg' || bgurl == 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/themebg/star.png' || bgurl == 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/themebg/point.png' || bgurl == 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/themebg/sakura.png')
  changeBG('#gribs-bg', 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/themebg/plaid.jpg')
  changeBG('#pixiv-bg', 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/themebg/star.png')
  changeBG('#KAdots-bg', 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/themebg/point.png')
  changeBG('#totem-bg', 'https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/themebg/little-monster.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://blog-img-1258635493.cos.ap-chengdu.myqcloud.com/cdn/img/other/starry_sky.png)')
